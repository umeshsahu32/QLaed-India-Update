export const faqData = [
...

  {
    ...
    question: "What is predictive lead scoring, and how does QLead use it?",
    answer:
      "Predictive lead scoring uses AI and machine learning to evaluate leads based on past behaviour, demographic information, and engagement levels. QLead employs predictive lead scoring to prioritize leads that are most likely to convert, ensuring your sales team focuses on the most promising prospects.",
  },
  {
    id: 19,
    section_id: 5,
  ...
  },
  {
    ...
    question: "Why is QLead better than leads from Google or Facebook?",
    answer:
      "Unlike platforms like Google and Facebook, which charge for all leads regardless of quality, QLead provides only qualified leads. This means you're paying for leads that have been vetted and match your specific criteria, reducing the time and resources spent on unqualified leads. Additionally, our leads come with detailed demographic information, conversation transcripts, and harmonic analysis, offering deeper insights.",
  },
  {
    id: 27,
    section_id: 8,
  ...
  },
  {
    ...
    section_id: 10,
    section_name: "Pricing & Packages",
    question: "How quickly can QLead deliver qualified leads after payment?",
    answer:
      "Once the platform fee is paid and the lead qualification criteria are set, QLead can deliver qualified leads within 6 to 12 working days, depending on the criteria and lead type. In many cases, leads are delivered even faster.",
  },
  {
    id: 37,
    section_id: 10,
    section_name: "Pricing & Packages",
    question: "Does QLead offer free sample leads?",
    answer:
      "As a policy, QLead does not provide free sample leads. We focus on delivering qualified leads that meet your criteria, ensuring value for your investment. Unlike other platforms, we do not charge for unqualified or junk leads.",
  },
];
